...
function toggleMenu() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    let slideItemWidth = slideItems[0].offsetWidth + 20; // Includes margin
    let index = 0;
    const totalSlides = slideItems.length / 2; // Assuming you have clones for infinite scroll
    ...
    setInterval(moveSlides, 1000); // Slide change every 1 second
  });
